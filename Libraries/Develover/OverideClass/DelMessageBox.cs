...
namespace Develover
{
    public class DelMessageBox
    {
        ...
        public static DialogResult DelMessageBoxPermission(Enum.EnumPermission enumPermission)
        {
            string text = StringMessage.Unknown;
            switch (enumPermission)
            {
                case Enum.EnumPermission.View:
                    {

                        text = StringMessage.PermissionDenialView;
                    }
                    break;
                case Enum.EnumPermission.New:
                    {
                        text = StringMessage.PermissionDenialNew;
                    }
                    break;
                case Enum.EnumPermission.Edit:
                    {
                        text = StringMessage.PermissionDenialEdit;
                    }
                    break;
                case Enum.EnumPermission.Delete:
                    {
                        text = StringMessage.PermissionDenialDelete;
                    }
                    break;
                case Enum.EnumPermission.Print:
                    {
                ...
                case Enum.EnumPermission.Denial:
                    {
